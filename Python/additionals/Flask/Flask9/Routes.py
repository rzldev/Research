...
from additionals.Flask.Flask9 import app, db, bcrypt
from additionals.Flask.Flask9.forms import RegistrationForm, LoginForm, UpdateForm, PostForm
from additionals.Flask.Flask9.Models import User, Post
...
## Route to user who posted the post
